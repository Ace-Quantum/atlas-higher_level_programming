...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        super().__init__(id)
        self.__width = Base.integer_validator("width", width)
        self.__height = Base.integer_validator("height", height)
        self.__x = Base.integer_validator("x", x)
        self.__y = Base.integer_validator("y", y)